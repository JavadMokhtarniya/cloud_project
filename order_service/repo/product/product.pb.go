...
var file_product_service_proto_product_proto_rawDesc = []byte{
	...
	,
...
var file_product_service_proto_product_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_product_service_proto_product_proto_goTypes = []interface{}{
	(*PID)(nil),   // 0: product.PID
	(*PInfo)(nil), // 1: product.PInfo
}
var file_product_service_proto_product_proto_depIdxs = []int32{
	0, // 0: product.ProductService.GetProduct:input_type -> product.PID
	1, // 1: product.ProductService.GetProduct:output_type -> product.PInfo
...
type ProductServiceClient interface {
	GetProduct(ctx context.Context, in *PID, opts ...grpc.CallOption) (*PInfo, error)
}
...
func (c *productServiceClient) GetProduct(ctx context.Context, in *PID, opts ...grpc.CallOption) (*PInfo, error) {
	out := new(PInfo)
...
type ProductServiceServer interface {
	GetProduct(context.Context, *PID) (*PInfo, error)
}
...
func (*UnimplementedProductServiceServer) GetProduct(context.Context, *PID) (*PInfo, error) {
...
func _ProductService_GetProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).GetProduct(ctx, req.(*PID))
	}
